    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="space-x-6 hidden md:flex">
            <button onClick={() => setActiveTab('services')} className={`hover:text-blue-600 ${activeTab === 'services' ? 'text-blue-600 font-semibold' : 'text-gray-700'}`}>
              Services
            </button>
            <button onClick={() => setActiveTab('about')} className={`hover:text-blue-600 ${activeTab === 'about' ? 'text-blue-600 font-semibold' : 'text-gray-700'}`}>
              About Me
            </button>
            <button onClick={() => setActiveTab('contact')} className={`hover:text-blue-600 ${activeTab === 'contact' ? 'text-blue-600 font-semibold' : 'text-gray-700'}`}>
              Contact
            </button>
          </nav>
        </div>
      ...
      <section className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-16 md:py-20 text-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Language Notice */}
          <div className="bg-white bg-opacity-20 backdrop-blur-sm border border-white border-opacity-30 rounded-lg p-4 max-w-xl mx-auto mb-8 inline-block">
          ...
          <section>
            ...
            <div className="mt-16 bg-blue-50 p-6 rounded-lg border border-blue-100">
              ...
              <ul className="space-y-2 text-gray-700 list-disc pl-5">
                ...
                <li><strong>Olen kokemuksellinen ja ammattitaitoinen</strong> – teen työni aina sinun ehdoissasi.</li>
              </ul>
            </div>
          </section>
        )}
        ...
        {activeTab === 'about' && (
          <section>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md max-w-3xl mx-auto">
              ...
              <p className="mb-4">
                Since arriving in Finland in 2018, I've turned handyman tasks into a side service to keep myself active and help others.
              </p>
